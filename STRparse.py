...
""",
    ...
    def fullanalysis(self):
        ...
        parser = argparse.ArgumentParser(
            description="Run the all STRparse functions (VCF & JSON parse, filter, and summarize)."
        )
        parser.add_argument(
            "-v",
            "--vcfinput",
        ...
        parser.add_argument(
            ...
            metavar="",
            required=True,
            help="Specify reference genome build in use (19, 37 or 38)",
        )
    ...
    def vcfparse(self):
        ...
        parser = argparse.ArgumentParser(
            description="Select VCF directory to be parsed."
        )
        parser.add_argument(
            "-i",
            "--vcfinput",
    ...
    def summaries(self):
        ...
        parser.add_argument(
            ...
            metavar="",
            required=True,
            help="Provide job identifier name",
        )
        parser.add_argument(
            "-b",
            "--gbuild",
    ...
    def jsonparse(self):
        ...
        parser = argparse.ArgumentParser(
            description="Select JSON directory to be parsed."
        )
        parser.add_argument(
            "-i",
            "--jsoninput",
    ...
    def filter(self):
        ...
        parser = argparse.ArgumentParser(
            description="Select VCF $ JSON files to filter."
        )
        parser.add_argument(
            "-v",
            "--vcfinput",
