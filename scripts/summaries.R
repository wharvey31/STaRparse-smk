...
outpath <- paste0(snakemake@output[["dirct"]], "/", snakemake@params[["cohort"]])

#RUN FUNCTIONS
locusdf <- by_locus(reads, snakemake@output[["dirct"]], snakemake@params[["cohort"]], snakemake@params[["build"]])
